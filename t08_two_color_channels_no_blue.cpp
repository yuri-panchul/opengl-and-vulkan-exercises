...
int main ()
{
    ...
    float vertices [] = {
        - 0.5f,   0.5f, 0.0f, 0.0f,  // Vertex 0 (X, Y) Black
          0.5f,   0.5f, 1.0f, 0.0f,  // Vertex 1 (X, Y) Red
          0.5f, - 0.5f, 0.0f, 1.0f,  // Vertex 2 (X, Y) Green
        - 0.5f, - 0.5f, 1.0f, 1.0f,  // Vertex 3 (X, Y) Yellow
    };
