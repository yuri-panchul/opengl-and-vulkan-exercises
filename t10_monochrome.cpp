...
int main ()
{
    ...
    float vertices [] = {
        - 0.5f,   0.5f, 1.0f, 1.0f, 1.0f,  // Vertex 0 (X, Y) White
          0.5f,   0.5f, 0.0f, 0.0f, 0.0f,  // Vertex 1 (X, Y) Black
          0.5f, - 0.5f, 0.5f, 0.5f, 0.5f,  // Vertex 2 (X, Y) Gray 0.5
        - 0.5f, - 0.5f, 0.3f, 0.3f, 0.3f,  // Vertex 3 (X, Y) Gray 0.3
    };
